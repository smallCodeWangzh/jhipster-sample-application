            ...
            <AvForm model={isNew ? {} : categoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="codeLabel" for="category-code">
                  <Translate contentKey="jhipsterSampleApplicationApp.category.code">Code</Translate>
                </Label>
                <AvField id="category-code" type="string" className="form-control" name="code" />
              </AvGroup>
              <AvGroup>
                <Label id="nameLabel" for="category-name">
                  <Translate contentKey="jhipsterSampleApplicationApp.category.name">Name</Translate>
                </Label>
