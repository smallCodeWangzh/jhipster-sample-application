...
export const ArticleDeleteDialog = (props: IArticleDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.article.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.article.delete.question" interpolate={{ id: articleEntity.id }}>
